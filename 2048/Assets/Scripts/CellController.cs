...
public class CellController : MonoBehaviour
{
    ...
    private void OnSlide(string whatWasSent){
        ...
        if(whatWasSent == "w"){
            if(up != null)
                return;
            CellController currentCell = this;
            SlideUp(currentCell);
        }
        if(whatWasSent == "d"){
            if(right != null)
    ...
    void SlideUp(CellController currentCell){
        if(currentCell.down == null)
            return;

        if(currentCell.fill != null){
            CellController nextCell = currentCell.down;
    ...
    void SlideRight(CellController currentCell){
        if(currentCell.left == null)
            return;

        if(currentCell.fill != null){
            CellController nextCell = currentCell.left;
    ...
    void SlideDown(CellController currentCell){
        if(currentCell.up == null)
            return;

        if(currentCell.fill != null){
            CellController nextCell = currentCell.up;
    ...
    void SlideLeft(CellController currentCell){
        if(currentCell.right == null)
            return;

        if(currentCell.fill != null){
            CellController nextCell = currentCell.right;
