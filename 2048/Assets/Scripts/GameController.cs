...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] CellController[] allCells;
    ...
    public void SpawnFill(){
        ...
        if(chance < .2f)
            ...
            FillController tempFillComp = tempFill.GetComponent<FillController>();
            allCells[whichSpawn].GetComponent<CellController>().fill = tempFillComp;
